...
projectEnv.bcrypt = require('bcryptjs');
projectEnv.cluster = require('cluster');
projectEnv.express = require('express');
projectEnv._ = projectEnv.lodash = require('lodash');
...
projectEnv.emit = require('./emit')();
projectEnv.middlewares = require('../middlewares/_index.js');
projectEnv.controllers = {};
projectEnv.controllers.init = require('../controllers/init');
projectEnv.controllers.spam = require('../controllers/spam');